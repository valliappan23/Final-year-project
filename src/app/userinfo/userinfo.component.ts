...
export class UserinfoComponent implements OnInit {
  userdata : {_id:Number,uname:String,cname:String,uattain:String,uaddr:String,uid:String,udob:String,udoj:String,uemail:String,uphone:String,cdesignation:String,cgender:String,upassword:String,usalary:String};
  ...
  ngOnInit(): void {
    this.activateRoute.params.subscribe((param:Params)=>{
      ...
      if(param['Userid']){
        this.UserSer.ViewUserData(param['Userid']).subscribe((data:any[])=>{
          console.log(data);
